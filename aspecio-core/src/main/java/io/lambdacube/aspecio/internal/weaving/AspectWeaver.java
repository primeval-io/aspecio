    ...
    public static WovenClassHolder weave(Class<?> clazzToWeave, Class<?>[] interfaces) {
        try {
            ...
            for (Method m : methods) {
                String argClassName = WovenMethodArgsGenerator.getName(clazzToWeave, m);
                byte[] methodArgsBytecode = WovenMethodArgsGenerator.generateMethodArgs(clazzToWeave, m);
                byteCodes.put(argClassName, methodArgsBytecode);
                String argClassUpdaterName = WovenMethodArgsUpdaterGenerator.getName(clazzToWeave, m);
                byte[] methodArgsUpdaterBytecode = WovenMethodArgsUpdaterGenerator.generateMethodArgsUpdater(clazzToWeave, m);
